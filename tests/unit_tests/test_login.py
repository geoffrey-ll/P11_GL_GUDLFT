...
def test_no_login_if_form_email_nonexistent(
        client, mock_filename_clubs, mock_filename_competitions):
    """Connexion impossible :

    Si aucun formulaire est envoyer avec la request.
    """
...
def test_no_login_unknown_email(
        client, mock_filename_clubs, mock_filename_competitions):
    """Connexion impossible :

    Si l'email est inconnu.
    """
...
def test_no_login_if_empty_email(
        client, mock_filename_clubs, mock_filename_competitions):
    """Connexion impossible :

    Si l'email du formulaire est vide.
    """
    server.load_database()
...
def test_login_if_a_known_email(
        client, mock_filename_clubs, mock_filename_competitions):
    """Connexion possible"""
