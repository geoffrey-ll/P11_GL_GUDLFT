...
def test_no_display_book_view_is_maximum_booking_is_zero(client, mock_filename_clubs, mock_filename_competitions):
    clubs, competitions = server.load_database()
...
def test_no_display_book_view_is_maximum_booking_is_negative(client, mock_filename_clubs, mock_filename_competitions):
    clubs, competitions = server.load_database()
...
def test_display_current_points_balance_clubs_in_points_board_view(client, mock_filename_clubs, mock_filename_competitions):
    clubs, competitions = server.load_database()
